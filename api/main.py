...
def generateStarPlot():
    ...
    plot = Plot(lat=lat, lng=lng, showConstellations=showConstellations, showMilkyWay=showMilkyWay, showEquator=showEquator, showHorizon=showHorizon,showEcliptic=showEcliptic, showOpenCluster=showOpenCluster, showGalaxies=showGalaxies, showMoon=showMoon, showGridLines=showGridLines)
    plot.generatePlot()
    b64 = plot.getBase64()
